...
{
       2,     0,     1,    13,     4,     0,     0,     3,     0,     8,
      11,    14,     0,     5,     0,     0,     0,     0,    12,     6,
       7,     9,    10
};
...
{
       2,    11,     3,     3,     4,     5,     5,    12,     6,     6,
      14,    15,    13,    14,    15,    18,    16,    17,    19,    20,
       0,     0,    21,    22
};
...
#line 1203 "DAG.tab.c"
  ...
  case 14: /* F: '-' number  */
#line 104 "DAG.y"
                { yyval = yyvsp[0]; yyval.value = tree[yyval.id].value = -yyval.value; 
                  string expr = '$' + tree[yyval.id].postfix; expr[1] = '-';
                  yyval.postfix = tree[yyval.id].postfix = expr; }
#line 1211 "DAG.tab.c"
    break;
